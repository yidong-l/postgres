...
PG_KEYWORD("aws_access_key_id", AWS_ACCESS_KEY_ID, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("aws_secret_access_key", AWS_SECRET_ACCESS_KEY, UNRESERVED_KEYWORD, BARE_LABEL)
